...
class Test {
  void runTest() {
    // 0. Tạo cửa hàng
    var cuaHang =
        CuaHang("Cửa Hàng ABC", "123 Xa Lộ Hà Nội, Thành phố Hồ Chí Minh");
    ...
    cuaHang.themDienThoai(DienThoai("DT-001", "iPhone 16 Pro Max 1TB", "Apple",
    ...
    cuaHang.themDienThoai(DienThoai(
        ...
        70,
        true));
    cuaHang.themDienThoai(DienThoai("DT-003", "Xiaomi 14T Pro 5G 12GB/256GB",
        "Xiaomi", 14500000, 17000000, 50, true));
